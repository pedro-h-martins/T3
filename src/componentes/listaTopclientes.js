...
export default function ListaTopClientes(props) {
    ...
    const [mostrarTopValorGasto, setMostrarTopValorGasto] = useState(false);

    const aplicarFiltro = (filtro) => {
        setFiltroSelecionado(filtro);
        setMostrarPlaceholder(false);
        setMostrarTopValorGasto(false);
    };

    const mostrarTopPorValorGasto = () => {
        setMostrarTopValorGasto(true);
        setMostrarPlaceholder(false);
                        ...
                        {!mostrarTopValorGasto ? (
                            ...
                            <article className="card mb-4">
                                <div className="card-header bg-success bg-opacity-10 d-flex justify-content-between align-items-center">
                                    ...
                                    <button className="btn btn-sm btn-danger" onClick={() => setMostrarTopValorGasto(false)}>
                            ...
                            <div className="card-body">
                                <div className="d-grid gap-2">
                                    <button
                                        ...
                                        onClick={() => aplicarFiltro('produtos')}
                                    >
                                    ...
                                    <button
                                        ...
                                        onClick={() => aplicarFiltro('servicos')}
                                    >
                                    ...
                                    <button
                                        ...
                                        onClick={mostrarTopPorValorGasto}
                                    >
